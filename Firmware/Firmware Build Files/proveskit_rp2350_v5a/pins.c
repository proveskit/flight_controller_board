...
static const mp_rom_map_elem_t board_module_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_RF2_IO3), MP_ROM_PTR(&pin_GPIO14) },
    ...
    { MP_ROM_QSTR(MP_QSTR_RF2_IO0), MP_ROM_PTR(&pin_GPIO23) },

    { MP_ROM_QSTR(MP_QSTR_WDT_WDI), MP_ROM_PTR(&pin_GPIO24) },
    { MP_ROM_QSTR(MP_QSTR_WDT_ENABLE), MP_ROM_PTR(&pin_GPIO25) },
